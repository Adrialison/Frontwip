...
export default function accesoriosPage() {
  ...
  const loadData = async () => {
    try {
      ...
      // Filtrar solo productos de categoría "accesorios"
      const accesorios = productsData.filter(
        (product) =>
          product.category?.nombre?.toLowerCase() === "accesorios" ||
          product.category?.nombre?.toLowerCase() === "accesorios"
      );
      ...
      console.log("🛒 Products:", accesorios);
    } catch (error) {
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-2xl text-gray-600">Cargando accesorios...</div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white shadow-sm">
        <div className="container mx-auto px-4 py-6">
          <h1 className="text-3xl font-bold text-gray-800">accesorios</h1>
